...
public class User {
    ...
    @OneToMany(mappedBy = "user") // Mapped by user, in line 27 from Task.java, you can see ManyToOne relationship
    private List<Task> tasks = new ArrayList<Task>(); // Class Task //One to many, cause one user can have many tasks
    ...
    @JsonIgnore // To retorn just the data of the user, and not return all the tasks
